...
vim.keymap.set("n", "<leader>le", ":lsp enable<CR>", { desc = "Enable LSP" })
vim.keymap.set("n", "<leader>ld", ":lsp disable<CR>", { desc = "Disable LSP" })
